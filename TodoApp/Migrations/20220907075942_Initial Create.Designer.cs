...
namespace TodoApp.Migrations
{
    ...
    [Migration("20220907075942_Initial Create")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoApp.Models.FoodItem", b =>
                {
            ...
            modelBuilder.Entity("TodoApp.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("TodoApp.Models.OrderMaster", b =>
                {
                    b.Property<long>("OrderMasterId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TodoApp.Models.OrderDetail", b =>
                {
                    b.HasOne("TodoApp.Models.FoodItem", "FoodItem")
                        .WithMany()
                        .HasForeignKey("FoodItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TodoApp.Models.OrderMaster", null)
